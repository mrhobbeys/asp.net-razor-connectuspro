...
CREATE USER [CONN950\SvcConnectusPro_STAG FOR LOGIN [CONN952\SvcConnectusPro_TRA]
GO

EXEC sp_addrolemember N'db_owner', N'CONN952\SvcConnectusPro_TRA'
