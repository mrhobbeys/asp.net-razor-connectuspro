...
(function (b) {
    ...
    jSlider.prototype = {
        ...
        setValue: function () {
            ...
            //console.log(d);
            $('#t1').val(d);
           // $("#t1").val("").trigger('change');
            //$("#t1").delay(3000).trigger('change').delay(3000);
            setTimeout(function(){jQuery('#t1').trigger('change');},2600);

            //$('#t1').delayedTrigger(4000, 'updatetable', 'change');
            //updatetable();
        //$('#t1').trigger('click');
